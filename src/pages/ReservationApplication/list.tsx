...
export type ReservationApplicationListProps = props;
export const ReservationApplicationList: React.FC<
  React.PropsWithChildren<ReservationApplicationListProps>
> = memo((props) => {
...
ReservationApplicationList.displayName = '预约列表';
